...
pub mod request {
    ...
    pub mod fetch {
        ...
        pub struct FetchRequest {
            ...
            #[kafka(versions = "12+", tagged = "12+", tag = 0i32, default = "null")]
    ...
    pub mod sasl_handshake {
        #[derive(Debug, PartialEq, Krost, Clone)]
        #[kafka(apikey = 17i16, versions = "0-1", flexible = "none")]
    ...
    pub mod offset_delete {
        #[derive(Debug, PartialEq, Krost, Clone)]
        #[kafka(apikey = 47i16, versions = "0", flexible = "none")]
    ...
    pub mod begin_quorum_epoch {
        #[derive(Debug, PartialEq, Krost, Clone)]
        #[kafka(apikey = 53i16, versions = "0", flexible = "none")]
    ...
    pub mod end_quorum_epoch {
        #[derive(Debug, PartialEq, Krost, Clone)]
        #[kafka(apikey = 54i16, versions = "0", flexible = "none")]
    ...
    pub mod fetch_snapshot {
        ...
        pub struct FetchSnapshotRequest {
            ///The clusterId if known, this is used to validate metadata fetches prior to broker registration
            #[kafka(versions = "0+", tagged = "0+", tag = 0i32, default = "null")]
            pub cluster_id: Option<krost::primitive::String>,
...
pub mod header {
    ...
    pub struct ResponseHeader {
        ...
        #[kafka(versions = "0+")]
        pub correlation_id: krost::primitive::Int32,
        ///The tagged fields.
        #[kafka(versions = "1+")]
        pub _tagged_fields: krost::primitive::TaggedFields,
    }
    ...
    pub struct RequestHeader {
        ...
        #[kafka(versions = "0+")]
        pub request_api_key: krost::primitive::Int16,
        ///The API version of this request.
        #[kafka(versions = "0+")]
        pub request_api_version: krost::primitive::Int16,
        ///The correlation ID of this request.
        #[kafka(versions = "0+")]
        pub correlation_id: krost::primitive::Int32,
        ///The client ID string.
        #[kafka(versions = "1+")]
        pub client_id: Option<krost::primitive::String>,
        ///The tagged fields.
        #[kafka(versions = "2+")]
        pub _tagged_fields: krost::primitive::TaggedFields,
    }
